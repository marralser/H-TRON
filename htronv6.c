/**************************************************************
*    htron.c                                   	              *
*    H-Tron - a DOS Tron game for VGA 640 x 480  *
*    written in Borland Turbo C 2.01                          *
*    Author: RobertK (RobertK@psc.at), December 2016          *
*    VGA conversion, + Amstrad Joytick ext  MRalser 2026      *
*                                                             *
*    Controls:                                                *
...
void InitPlayfield()
{
  ...
  /* Draw border */
  setcolor(WALL_COLOR);
  rectangle(0,0,639,479);  /* outer border */
  rectangle(7,6,632,18);   /* score area */
  rectangle(7,23,632,474); /* inner border (playfield) */
...
void main()
{
  ...
  clrscr();
  printf("*** H-Tron ***\n");
  printf("A DOS game for a VGA graphics card (640 x 480),\n");
  printf("written 2016 by RobertK (RobertK@psc.at), extended by MRalser 2026.\n\n");
